...
#t0:checked~.as-tabbar label[for=t0],
#t1:checked~.as-tabbar label[for=t1],
#t2:checked~.as-tabbar label[for=t2],
#t3:checked~.as-tabbar label[for=t3],
#t4:checked~.as-tabbar label[for=t4],
#t5:checked~.as-tabbar label[for=t5]{
  color:var(--accent); background:var(--bg-elev);
  border-color:var(--border); border-bottom-color:var(--bg-elev);
}
#t0:checked~.as-panels #p0,
#t1:checked~.as-panels #p1,
#t2:checked~.as-panels #p2,
#t3:checked~.as-panels #p3,
#t4:checked~.as-panels #p4,
#t5:checked~.as-panels #p5{display:block}
