...
3. **🛡️ Danger Index** — **14 weighted security categories summing to 1000 points**, a saturating violation-density curve per category, and bands Hardened / Minor exposure / Elevated risk / Critical exposure. 96 rules total: 3 universal (hardcoded secrets/CWE-798, private keys/CWE-321, SQL interpolation/CWE-89) plus language-scoped rules covering cryptography, injection, CSRF/CWE-352, unrestricted file upload/CWE-434, open redirect/CWE-601, path traversal, SSRF, insecure TLS, deserialization, sensitive logging and more. Findings are attributed to their last author via `git blame`.
